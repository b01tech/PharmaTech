...
{
    private static Role CreateValidRole() => Role.Create("Admin", "Administrator role", []).Data!;

    [Fact]
    public void Create_WithValidData_Should_Return_Success()
    {
        var role = CreateValidRole();
        var result = User.Create("John Doe", "john@example.com", role);
    ...
    {
        var role = CreateValidRole();
        var result = User.Create("Jo", "john@example.com", role);
    ...
    {
        var role = CreateValidRole();
        var result = User.Create("John Doe", "invalid-email", role);
    ...
    {
        var role = CreateValidRole();
        var result = User.Create("John Doe", "john@example.com", role, "https://example.com/avatar.png");
    ...
    {
        var role = CreateValidRole();
        var user = User.Create("John Doe", "john@example.com", role).Data;
    ...
    {
        var role1 = Role.Create("Admin", "Admin role", []).Data;
        var role2 = Role.Create("User", "User role", []).Data;
        var user = User.Create("John Doe", "john@example.com", role1).Data;
